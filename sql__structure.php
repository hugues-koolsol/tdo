...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__css` (
   ...
   `fld_json_css` text COLLATE utf8_unicode_ci NOT NULL,
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__langvalues` (
   ...
   `fld_key_lngVals` varchar(128) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'\',
   `fld_lang_lngVals` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'\',
   `fld_page_id_lngVals` bigint(20) unsigned DEFAULT NULL,
   `fld_value_lngVals` text COLLATE utf8_unicode_ci NOT NULL,
   `fld_type_lngVals` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'page\',
 ...
 ) ENGINE=MyISAM AUTO_INCREMENT=1938 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci';
 if(!($result=mysqli_query($dbLink,$sql))){
  $err=1;
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__log` (
   ...
   `fld_sql_log` text NOT NULL,
   `fld_bnf_log` varchar(64) NOT NULL,
   `fld_line_log` int(11) NOT NULL DEFAULT \'0\',
   `fld_user_id_log` bigint(20) unsigned NOT NULL DEFAULT \'0\',
   `fld_typ_log` enum(\'1\',\'2\',\'3\') NOT NULL DEFAULT \'1\' COMMENT \'{"comment":"1:sql, 2 error , 3 information"}\'
...
if($err==0){
 ...
 ) ENGINE=MyISAM AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT=\'{"remote":false}\'';
 if(!($result=mysqli_query($dbLink,$sql))){
  $err=1;
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__paramnames` (
   ...
   `fld_order_parnams` text COLLATE utf8_unicode_ci NOT NULL,
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__paramvalues` (
   ...
   `fld_json_parvals` text COLLATE utf8_unicode_ci NOT NULL,
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__tablelinks` (
   ...
   `fld_parent_field_pglnks` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'\',
   `fld_parent_field_display_pglnks` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'\',
   `fld_children_table_id_pglnks` bigint(20) unsigned NOT NULL DEFAULT \'0\',
   `fld_child_field_pglnks` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'\',
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__users` (
   ...
   `fld_firstname_users` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'\',
   `fld_lastname_users` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT \'\',
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__zztests` (
   ...
   `fld_color1_zztests` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT \'{"subtype":"webcolor"}\',
