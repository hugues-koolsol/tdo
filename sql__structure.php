...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__css` (
   ...
   `fld_name_css` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\' COMMENT \'{"showDeleteField":true}\',
   `fld_active_css` tinyint(4) NOT NULL DEFAULT \'0\' COMMENT \'{"param":"yorno"}\',
   `fld_color_back_css` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT \'{"subtype":"webcolor"}\',
   `fld_color_text_css` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT \'{"subtype":"webcolor"}\',
   `fld_json_css` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__groups` (
   ...
   `fld_name_groups` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\' COMMENT \'{"showDeleteField":true}\',
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__langvalues` (
   ...
   `fld_key_lngVals` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
   `fld_lang_lngVals` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
   `fld_page_id_lngVals` bigint(20) unsigned DEFAULT NULL,
   `fld_value_lngVals` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
   `fld_type_lngVals` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'page\',
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__log` (
   ...
   `fld_sql_log` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
   `fld_bnf_log` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
   `fld_line_log` int(11) NOT NULL DEFAULT \'0\',
   `fld_user_id_log` bigint(20) unsigned NOT NULL DEFAULT \'0\',
   `fld_typ_log` enum(\'1\',\'2\',\'3\') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'1\' COMMENT \'{"comment":"1:sql, 2 error , 3 information"}\'
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__pages` (
   ...
   `fld_name_pages` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\' COMMENT \'{"showDeleteField":true}\',
 ...
 ) ENGINE=MyISAM AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT=\'{"remote":false}\'';
 if(!($result=mysqli_query($dbLink,$sql))){
  $err=1;
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__paramnames` (
   ...
   `fld_key_parnams` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\' COMMENT \'{"showDeleteField":true}\',
   `fld_label_parnams` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
   `fld_comment_parnams` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
   `fld_json_parnams` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
   `fld_order_parnams` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__paramvalues` (
   ...
   `fld_json_parvals` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__tablelinks` (
   ...
   `fld_parent_field_pglnks` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
   `fld_parent_field_display_pglnks` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
   `fld_children_table_id_pglnks` bigint(20) unsigned NOT NULL DEFAULT \'0\',
   `fld_child_field_pglnks` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
 ...
 ) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT=\'{"remote":false}\'';
 if(!($result=mysqli_query($dbLink,$sql))){
  $err=1;
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__tables` (
   ...
   `fld_name_tables` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\' COMMENT \'{"showDeleteField":true}\',
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__users` (
   ...
   `fld_login_users` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\' COMMENT \'{"showDeleteField":true}\',
   `fld_email_users` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
   `fld_loginisemail_users` tinyint(4) NOT NULL DEFAULT \'0\' COMMENT \'{"param":"yorno"}\',
   `fld_password_users` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
   ...
   `fld_firstname_users` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
   `fld_lastname_users` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl__zztests` (
   ...
   `fld_yorno1_zztests` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT \'{"param":"yorno","unsetPossible":true}\',
   `fld_visited_countries_zztests` set(\'FR\',\'US\',\'GB\',\'BE\',\'KO\',\'ES\') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT \'{"param":"country","set":true}\',
   `fld_country1_zztests` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'FR\' COMMENT \'{"param":"country","dropDown":"true","unsetPossible":true}\',
   `fld_title32_zztests` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\' COMMENT \'{"showDeleteField":true}\',
   ...
   `fld_color1_zztests` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT \'{"subtype":"webcolor"}\',
 ...
 ) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT=\'{"remote":false}\'';
 if(!($result=mysqli_query($dbLink,$sql))){
  $err=1;
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl_todos` (
   ...
   `fld_title_todos` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'todo\' COMMENT \'{"showDeleteField":true}\',
   `fld_comment_todos` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
if($err==0){
 ...
 $sql='CREATE TABLE `tdo_tbl_uploadeddocs` (
   ...
   `fld_name_uploadedDocs` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\' COMMENT \'{"showDeleteField":true}\',
   `fld_originalName_uploadedDocs` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
   `fld_isPicture_uploadedDocs` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT \'{"param":"yorno","unsetPossible":false}\',
   ...
   `fld_documentType_uploadedDocs` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
   `fld_pictureWeight_uploadedDocs` bigint(20) unsigned NOT NULL DEFAULT \'0\',
   `fld_path_uploadedDocs` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'\',
